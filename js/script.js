...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function getStaticInforation(parentSelector, activeClass) {
    ...
    getStaticInforation('#gender', 'calculating__choose-item_active');
    getStaticInforation('.calculating__choose_big', 'calculating__choose-item_active');
